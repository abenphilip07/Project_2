...
def extract_features_from_video(video_path, model, transform, frame_sample_rate=10):
    ...
    if frame_features:
        ...
        return np.zeros((2048,))  # Default to a zero vector if no frames were processed

# Load metadata
metadata_path =  r'E:\Project_2\data\FakeAVCeleb_Sampled\chunks\metadata.json'  # Replace with your metadata file path
output_feature_dir = r'E:\Project_2\data\Features'  # Directory to store extracted features
updated_metadata_path = "updated_metadata.json"
